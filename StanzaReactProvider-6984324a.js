import { h as hasOwn, E as Emotion$1, c as createEmotionProps, m as memoize$1, _ as _extends, w as withEmotionCache, r as reactExports, T as ThemeContext$2, g as getRegisteredStyles, s as serializeStyles, a as registerStyles, u as useInsertionEffectAlwaysWithSyncFallback, i as insertStyles, G as Global, R as React$2, b as css, C as CacheProvider, d as createCache$1 } from './index-7a88ba65.js';
import { g as getDefaultExportFromCjs, S as Stanza } from './stanza-3bc73db1.js';
...
var REACT_CONSUMER_TYPE$1 = Symbol.for("react.consumer"),
  ...
  REACT_OFFSCREEN_TYPE$1 = Symbol.for("react.offscreen"),
...
const use$1 = React$2.use || ((promise) => {
...
const EmotionGlobalStyles = () => {
    return jsx(Global, { styles: styles });
};
const styles = css `
  * {
    margin: 0;
...
const EmotionCacheProvider = ({ children }) => {
    ...
    return (jsxs(CacheProvider, { value: myCache, children: [jsx(EmotionGlobalStyles, {}), jsx("div", { ref: containerRef, children: children })] }));
};
...
const StanzaReactProvider = ({ children }) => {
    return (jsx(reactExports.StrictMode, { children: jsx(QueryClientProvider, { client: queryClient, children: jsx(Provider, { children: jsx(ThemeProvider, { theme: muiTheme, children: jsxs(EmotionCacheProvider, { children: [jsx("style", { children: `:host{--color-primary-dark:color-mix(in srgb, var(--color-primary), black 25%)}` }), children] }) }) }) }) }));
};
...
class TogoMediumReactStanza extends Stanza {
    ...
    _render() {
        ...
        this.reactRoot.render(jsx(StanzaReactProvider, { children: children }));
...
export { capitalize as A, formatMuiErrorMessage as B, rootShouldForwardProp$1 as C, resolveProps as D, deepmerge as E, Fragment as F, GlobalStyles as G, useRtl as H, slotShouldForwardProp as I, preprocessStyles as J, useDefaultProps as K, createTheme$1 as L, useTheme$1 as M, reactDomExports as N, defaultSxConfig$1 as O, isPlainObject$1 as P, clamp as Q, ReactDOM$1 as R, Subscribable as S, THEME as T, lighten as U, darken as V, replaceEqualDeep as W, styled$2 as X, styleFunctionSx$1 as Y, createTheme as Z, jsxs as a, TogoMediumReactStanza as b, shallowEqualObjects as c, resolveStaleTime as d, isValidTimeout as e, focusManager as f, fetchState as g, replaceData as h, isServer as i, jsx as j, notifyManager as k, atom as l, useAtomValue as m, noop$5 as n, useSetAtom as o, pendingThenable as p, jsxRuntimeExports as q, resolveEnabled as r, styled$1 as s, timeUntilStale as t, useQueryClient as u, defaultTheme$1 as v, THEME_ID as w, alpha as x, getOverlayAlpha as y, useEnhancedEffect$1 as z };
//# sourceMappingURL=StanzaReactProvider-6984324a.js.map
