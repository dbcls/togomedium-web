...
* Satanza用と Web用で作業フォルダや使用技術が微妙に異なります。ユーザーの指示が曖昧な場合は、必ず Stanza or Web のどちらか確認をしてください。

## 作業フォルダ
- Stanza用
  - `@packages/stanza/components/icons`
- Web 用
  - `@packages/web/src/components/atoms/svg`
