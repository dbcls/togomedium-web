  ...
  return (
    <section>
      ...
      <SearchPane
        ...
        buttonLabel={"Search"}
      >
        <div className={"border-small flex flex-col gap-3 rounded p-3"}>
          <p>
          ...
          <div>
            ...
            <div className={"flex flex-wrap gap-x-2"}>
              <Link to={"/search"} search={{ query: "Glucose" }} className={basicTextLink}>
                Glucose
              </Link>
              <span>/</span>
              <Link to={"/search"} search={{ query: "M10" }} className={basicTextLink}>
                M10
              </Link>
              <span>/</span>
              <Link to={"/search"} search={{ query: "MRS Medium" }} className={basicTextLink}>
                MRS Medium
              </Link>
              <span>/</span>
              <Link
