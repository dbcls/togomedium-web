import { g as getDefaultExportFromCjs, S as Stanza } from './stanza-0294ba58.js';
 ...
 */
var REACT_ELEMENT_TYPE$3 = Symbol.for("react.transitional.element"),
  REACT_FRAGMENT_TYPE$3 = Symbol.for("react.fragment");
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  for (var _key2 in props) {
    if (hasOwn$1.call(props, _key2) && _key2 !== 'css' && _key2 !== typePropName && (!isDevelopment$1 )) {
...
const EmotionGlobalStyles = () => {
    return jsx$1(Global, { styles: styles });
};
const styles = css `
  * {
    margin: 0;
...
const EmotionCacheProvider = ({ children }) => {
    ...
    const createMyCache = () => createCache$1({
        key: "stanza",
        container: containerRef.current,
    });
    const [myCache, setMyCache] = reactExports.useState(createMyCache);
    reactExports.useEffect(() => setMyCache(createMyCache), []);
    return (jsxs(CacheProvider, { value: myCache, children: [jsx$1(EmotionGlobalStyles, {}), jsx$1("div", { ref: containerRef, children: children })] }));
};
...
reactIs_production.ContextConsumer = REACT_CONSUMER_TYPE$1;
reactIs_production.ContextProvider = REACT_CONTEXT_TYPE$1;
reactIs_production.Element = REACT_ELEMENT_TYPE$1;
reactIs_production.ForwardRef = REACT_FORWARD_REF_TYPE$1;
reactIs_production.Fragment = REACT_FRAGMENT_TYPE$1;
reactIs_production.Lazy = REACT_LAZY_TYPE$1;
reactIs_production.Memo = REACT_MEMO_TYPE$1;
reactIs_production.Portal = REACT_PORTAL_TYPE$2;
reactIs_production.Profiler = REACT_PROFILER_TYPE$1;
reactIs_production.StrictMode = REACT_STRICT_MODE_TYPE$1;
reactIs_production.Suspense = REACT_SUSPENSE_TYPE$1;
reactIs_production.SuspenseList = REACT_SUSPENSE_LIST_TYPE$1;
reactIs_production.isContextConsumer = function (object) {
  return typeOf(object) === REACT_CONSUMER_TYPE$1;
};
reactIs_production.isContextProvider = function (object) {
  return typeOf(object) === REACT_CONTEXT_TYPE$1;
};
...
reactIs_production.isLazy = function (object) {
  return typeOf(object) === REACT_LAZY_TYPE$1;
};
reactIs_production.isMemo = function (object) {
  return typeOf(object) === REACT_MEMO_TYPE$1;
};
reactIs_production.isPortal = function (object) {
  return typeOf(object) === REACT_PORTAL_TYPE$2;
};
reactIs_production.isProfiler = function (object) {
  return typeOf(object) === REACT_PROFILER_TYPE$1;
};
reactIs_production.isStrictMode = function (object) {
  return typeOf(object) === REACT_STRICT_MODE_TYPE$1;
};
reactIs_production.isSuspense = function (object) {
  return typeOf(object) === REACT_SUSPENSE_TYPE$1;
};
reactIs_production.isSuspenseList = function (object) {
  return typeOf(object) === REACT_SUSPENSE_LIST_TYPE$1;
};
reactIs_production.isValidElementType = function (type) {
  return "string" === typeof type ||
    "function" === typeof type ||
    type === REACT_FRAGMENT_TYPE$1 ||
    type === REACT_PROFILER_TYPE$1 ||
    type === REACT_STRICT_MODE_TYPE$1 ||
    type === REACT_SUSPENSE_TYPE$1 ||
    type === REACT_SUSPENSE_LIST_TYPE$1 ||
    ("object" === typeof type &&
      null !== type &&
      (type.$$typeof === REACT_LAZY_TYPE$1 ||
        type.$$typeof === REACT_MEMO_TYPE$1 ||
        type.$$typeof === REACT_CONTEXT_TYPE$1 ||
        type.$$typeof === REACT_CONSUMER_TYPE$1 ||
        type.$$typeof === REACT_FORWARD_REF_TYPE$1 ||
...
var ReactDOM$1 = /*@__PURE__*/getDefaultExportFromCjs(reactDomExports);
...
const use$1 = React$3.use || // A shim for older React versions
((promise) => {
...
function useAtomValue(atom, options) {
  const { delay, unstable_promiseStatus: promiseStatus = !React$3.use } = options || {};
  const store = useStore$1(options);
...
function shallowEqual(objA, objB) {
  ...
  for (keysB = 0; keysB < keysA.length; keysB++) {
    ...
    if (
      ...
      !objectIs$1(objA[currentKey], objB[currentKey])
    )
      return !1;
  }
  return !0;
...
function areHookInputsEqual(nextDeps, prevDeps) {
  ...
  for (var i = 0; i < prevDeps.length && i < nextDeps.length; i++)
    if (!objectIs$1(nextDeps[i], prevDeps[i])) return !1;
  return !0;
}
...
(function (module) {
	...
	{
	  module.exports = useSyncExternalStoreWithSelector_production;
	}
} (withSelector));
...
const StanzaReactProvider = ({ children, reduxStore, }) => {
    const ReduxWrapper = ({ children }) => reduxStore ? jsx$1(Provider_default, { store: reduxStore, children: children }) : jsx$1(Fragment, { children: children });
    return (jsx$1(reactExports.StrictMode, { children: jsx$1(QueryClientProvider, { client: queryClient, children: jsx$1(Provider$1, { children: jsx$1(ReduxWrapper, { children: jsx$1(ThemeProvider, { theme: muiTheme, children: jsxs(EmotionCacheProvider, { children: [jsx$1("style", { children: `:host{--color-primary-dark:color-mix(in srgb, var(--color-primary), black 25%)}` }), children] }) }) }) }) }) }));
};
...
class TogoMediumReactStanza extends Stanza {
    reactElm = this.root.querySelector("main");
    reactRoot = clientExports.createRoot(this.reactElm);
    reduxStore;
    async render() {
        this._render();
    ...
    _render() {
        ...
        this.reactRoot.render(jsx$1(StanzaReactProvider, { reduxStore: this.reduxStore, children: children }));
        ...
        setTimeout(() => {
            try {
                ...
                const childWrapper = main.children[0];
...
export { isPlainObject$1 as $, jsxRuntimeExports as A, rootShouldForwardProp$1 as B, useEnhancedEffect$1 as C, useRtl as D, defaultTheme$1 as E, Fragment as F, GlobalStyles as G, THEME_ID as H, alpha as I, getOverlayAlpha as J, keyframes as K, formatMuiErrorMessage as L, resolveProps as M, useId as N, deepmerge as O, slotShouldForwardProp as P, css as Q, React$3 as R, Subscribable as S, THEME as T, preprocessStyles as U, useDefaultProps as V, useTheme$1 as W, ReactDOM$1 as X, reactDomExports as Y, defaultSxConfig$1 as Z, _extends as _, jsxs as a, clamp as a0, replaceEqualDeep as a1, styled$2 as a2, styleFunctionSx$1 as a3, createTheme as a4, createStyled as a5, createTheme$1 as a6, handleBreakpoints as a7, resolveBreakpointValues as a8, createUnarySpacing as a9, mergeBreakpointsInOrder as aa, getValue as ab, emphasize as ac, useDispatch as ad, useSelector as ae, useStore as af, TogoMediumReactStanza as b, shallowEqualObjects as c, resolveStaleTime as d, isValidTimeout as e, timeoutManager as f, focusManager as g, fetchState as h, isServer as i, jsx$1 as j, replaceData as k, notifyManager as l, reactExports as m, noop$2 as n, shouldThrowError as o, pendingThenable as p, jsx as q, resolveEnabled as r, styled$1 as s, timeUntilStale as t, useQueryClient as u, atom as v, useAtomValue as w, useSetAtom as x, capitalize as y, clsx as z };
//# sourceMappingURL=StanzaReactProvider-6021d3e7.js.map
