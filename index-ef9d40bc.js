import { g as getDefaultExportFromCjs, a as getAugmentedNamespace, c as commonjsGlobal } from './stanza-ee9dc64c.js';
...
const addClassIf = (target, condition, token, alt = "", remove = true) => {
    ...
    targets.forEach((elm) => process$1(elm, condition, token, remove, alt));
};
addClassIf$1.addClassIf = addClassIf;
const process$1 = (target, condition, token, remove = true, alt = "") => {
...
export { CacheProvider as C, Emotion$1$1 as E, Global as G, React as R, ThemeContext as T, _extends as _, registerStyles as a, css as b, createEmotionProps as c, createCache as d, dist as e, React$1 as f, getRegisteredStyles as g, hasOwn as h, insertStyles as i, jsx as j, keyframes as k, memoize as m, reactExports as r, serializeStyles as s, useInsertionEffectAlwaysWithSyncFallback as u, withEmotionCache as w };
//# sourceMappingURL=index-ef9d40bc.js.map
