    ...
    >
      ...
      >
        ...
        <p>
          ...
          resource centers (BRCs) around the world. Currently, 787 culture collections are listed in
          Culture Collections Information Worldwide (CCINFO) provided by the World Data Centre for
          Microorganisms (WDCM). These culture collections are not only essential infrastructure for
          conducting microbial research but also serve as valuable sources of rich information,
          including microbial physiological and phenotypic information that is described in the
          accompanying metadata of each microorganism. Through our collaborative efforts with
          BioResource Research Center, Riken, and Biological Resource Center, National Institute of
          Technology and Evaluation (NITE), the metadata of their culture collections, namely JCM
          and NBRC, have been converted into RDF datasets. Both datasets are available on the NBDC
          RDF portal.
        </p>
        <p>
          ...
          includes one or more links to web documents that describe how to prepare growth media for
          the corresponding microorganism. Along with the development of the RDF datasets mentioned
          above, we have also independently developed an RDF dataset that focuses on the ingredients
          of microbial growth media whose recipes are provided by JCM and NBRC.
        </p>
        <p>
